...
- **Marketing API** -> It is REST type api dummyjson/posts, contain social media data having information about user posts & comments, in project purposes only tags, reactions, and views will be used for later use, rest will stay in bronze layer
